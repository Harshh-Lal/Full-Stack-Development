...
export default function Home() {
    ...
    return (
        <main className="relative pt-16 sm:pt-20">
                        ...
                        {techCards.map((card) => (
                            <div key={card.title} className="group relative h-72 sm:h-96 lg:h-[450px] rounded-xl overflow-hidden bg-card-dark neon-border card-hover-reveal border border-white/5">
                                <div className="absolute inset-0">
                                    <img alt={card.title} loading="lazy" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src={card.image} />
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-6">
                                    ...
                                    <div className="space-y-3 bg-glass-bg backdrop-blur-md p-4 rounded-lg border border-white/10 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
            ...
            {/* ─── CONTACT ─── */}
            <section id="reach-out" className="py-24 bg-bg-dark relative">
                    ...
                    <div className="max-w-4xl mx-auto bg-card-dark border border-white/10 rounded-2xl p-6 sm:p-8 md:p-12 shadow-2xl overflow-hidden relative">
                        ...
                        <div className="relative z-10 grid md:grid-cols-2 gap-12">
                            ...
                            <form className="space-y-4" onSubmit={(e) => {
                                ...
                                <button className="w-full py-4 bg-primary text-bg-dark font-bold text-lg rounded-lg hover:bg-[#ffffff] hover:text-[#000000] hover:shadow-[0_0_20px_rgba(13,242,89,0.5)] transition-all flex items-center justify-center gap-2 group">
